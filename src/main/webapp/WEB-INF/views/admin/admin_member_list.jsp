				...
				<div class="col-md-9 contact-info">
					...
					<table class="n-table table-col" style="width: 100%; border-collapse: separate; border-spacing: 0 10px;">
						...
						<tbody>
							...
							<tr onClick="location.href='${pageContext.request.contextPath}/admin/mypage/member/${mbr.mbr_id}'" style="cursor: pointer; text-align: center; border-bottom: 10px solid #fff;"> 
								<td scope="col" >${mbr.mbr_id }</td>
								<td scope="col" >${mbr.mbr_name }</td>
								<td scope="col">${mbr.contact_number }</td>
								<td scope="col">${mbr.jdate }</td>
								<td scope="col" onclick="event.cancelBubble=true" ><button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/admin/mypage/member/${mbr.mbr_id}/order'">조회</button></td>
							</tr>
							</c:forEach>
						</tbody>
					</table>
