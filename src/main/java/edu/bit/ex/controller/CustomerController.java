...
public class CustomerController {
	...
	public ModelAndView reviewRegister(@AuthenticationPrincipal MemberDetails memberDetails, ModelAndView mav, BoardVO boardVO) throws Exception {
		...
		// 리뷰 등록
		customerService.setReviewWrite(boardVO);
		return mav;
	}
	...
	public ModelAndView reviewList(@AuthenticationPrincipal MemberDetails memberDetails, ModelAndView mav) throws Exception {
		...
		mav.setViewName("customer/member_myreview_list");
