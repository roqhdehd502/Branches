			...
			<div class="row">
				...
				<span style="border-left: 1px solid rgba(0, 0, 0, .1); width: 822px;">
            		...
            		<span style="margin-left: 170px;">
             		  <h2 style="position: relative; top: 10px;">29,900₩</h2>
            		</span><br/>
            		<span style="margin-left: 20px;">
               			<button class="btn btn-primary btn-sm" type="button">배송조회</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               			<button class="btn btn-primary btn-sm" type="button">배송취소</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<form action="#" method="post">   
			            ...
			            <span>
			               ...
			               <span style="margin-left: 500px"><h5>Total</h5><h3>59,000₩</h3></span>            
			            </span>
			         </form>   
			      </span>
			</div>
