		...
		<div class="container">
			<div class="row">
				...
				<span style="border-left: 1px solid rgba(0, 0, 0, .1); width: 922px;">
					...
					<div>
						<span style="margin-left: 30px;"><button class="btn btn-primary btn-sm">일간</button></span> <span style="margin-left: 30px;"><button
								class="btn btn-primary btn-sm">주간</button></span> <span style="margin-left: 30px;"><button class="btn btn-primary btn-sm">월간</button></span> <span
							style="margin-left: 30px;"><button class="btn btn-primary btn-sm">연간</button></span> <span style="margin-left: 30px;"><button
								class="btn btn-primary btn-sm">전체</button></span>
						<form action="#" style="float: right;">
							<span style="margin-left: 30px;"><h6>지정</h6></span> <span style="margin-left: 10px;"> <select>
									<option>대분류</option>
									<option>상의</option>
									<option>하의</option>
									<option>아우터</option>
							...
							</span> <span style="margin-left: 10px;"><button class="btn btn-primary btn-sm" type="submit">조회</button></span>
						</form>
					</div>
					<hr>
					<div>
