			...
			<div class="row">
				<div class="col-md-2 contact-info" align="center">
					<div class="single-info">
						<div id="accordion">
							<span><h4 style="margin-top: 10px;">OUTER</h4></span>
							<span style="margin-left: 38px;">
								<button type="button" class="btn btn-white btn-sm" data-toggle="collapse" data-target="#demo" style="padding: 5px 5px 5px 5px;"><h5 class="text-dark"> + </h5></button>
							</span>
							...
							<span><h4 style="margin-top: 10px;">TOP</h4></span>
							<span style="margin-left: 72px;">
								<button type="button" class="btn btn-white btn-sm" data-toggle="collapse" data-target="#demo1" style="padding: 5px 5px 5px 5px;"><h5 class="text-dark"> + </h5></button>
							</span>
							...
							<span><h4 style="margin-top: 10px;">BOTTOM</h4></span>
							<span style="margin-left: 22px;">
								<button type="button" class="btn btn-white btn-sm" data-toggle="collapse" data-target="#demo2" style="padding: 5px 5px 5px 5px;"><h5 class="text-dark"> + </h5></button>
							</span>
							...
							<span><h4 style="margin-top: 10px;">DRESS</h4></span>
							<span style="margin-left: 44px;">
								<button type="button" class="btn btn-white btn-sm" data-toggle="collapse" data-target="#demo3" style="padding: 5px 5px 5px 5px;"><h5 class="text-dark"> + </h5></button>
							</span>
							...
							<span><h4 style="margin-top: 10px;">SHOES</h4></span>
							<span style="margin-left: 44px;">
								<button type="button" class="btn btn-white btn-sm" data-toggle="collapse" data-target="#demo5" style="padding: 5px 5px 5px 5px;"><h5 class="text-dark"> + </h5></button>
							</span>
							...
							<span><h4 style="margin-top: 10px;">ETC</h4></span>
							<span style="margin-left: 80px;">
								<button type="button" class="btn btn-white btn-sm" data-toggle="collapse" data-target="#demo6" style="padding: 5px 5px 5px 5px;"><h5 class="text-dark"> + </h5></button>
							</span>
				...
				<span style="border-left: 1px solid rgba(0, 0, 0, .1); width: 922px;">
					...
					<div style="margin-bottom: 20px; margin-top: 20px;">
						<span style="margin-left: 30px;"><button class="btn btn-primary btn-sm" type="button"><a>ㄱㄴㄷ순</a></button></span>
