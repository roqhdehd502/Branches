...
<body class="text-center">
    <form class="form-signin" th:action="@{/register}" method="post">
        ...
        <input type="text" id="mbr_id" name="mbr_id" class="form-control" placeholder="ID" required autofocus>
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="mbr_pw" name="mbr_pw" class="form-control" placeholder="Password" required>
