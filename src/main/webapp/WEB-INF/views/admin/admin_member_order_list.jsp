		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9 contact-info" style="align-content: center;">
					<h3 >
					<strong>${mbr.mbr_name} / ${mbr.mbr_id} 주문 목록</strong>
					</h3><hr>
					...
					<table class="n-table table-col" style="width: 100%; border-collapse: separate; border-spacing: 0 10px;">
						...
						<thead>
							<tr style="text-align: center; border-bottom: 1px solid #444444;">
								<th scope="col"><h5><strong>주문번호</strong></h5></th>
								<th scope="col"><h5><strong>주문금액</strong></h5></th>
								<th scope="col"><h5><strong>주문날짜</strong></h5></th>
								<th scope="col"><h5><strong>주문상태</strong></h5></th>
								<th scope="col"><h5><strong>상세내역</strong></h5></th>
							</tr>
						</thead>
						<tbody>
							...
							<tr style="text-align: center;">
								...
								<td scope="col" >${order.order_price}</td>
								<td scope="col">${order.order_date}</td>
								<td scope="col">${order.order_state_name}</td>
								<td scope="col" onclick="event.cancelBubble=true" ><button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/admin/mypage/member/${mbr.mbr_id}/order/${order.order_number}'">조회</button></td>
							</tr>
							</c:forEach>
						</tbody>
					</table>
