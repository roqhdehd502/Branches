			...
			<div class="row">
				...
				<span style="border-left: 1px solid rgba(0, 0, 0, .1); width: 922px;">
					...
					<div class="team-area sp">
						<div class="container">
							<div class="row">
								<form id="searchForm" action="/seller/mypage/refund" method="get" style="position: relative; left: 480px; bottom :20px;">
									<span>
								...
								<table class="table">
									...
									<tbody>
										<c:forEach items="${refund }" var="prdct">
											<tr style="text-align: center;">
												...
												<td>
													<c:if test="${prdct.order_state_number eq 10}">
														<h5 style="position: relative; top: 20px;">환불요청</h5>
													</c:if>
